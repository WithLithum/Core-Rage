...
namespace WithLithum.Core
{
    ...
    public static class WWorld
    {
        ...
        /// <returns>
        ///   <para>A <see cref="Rage.Vector3" /> indicating the generated spawn point.</para>
        /// </returns>
        ...
        /// <param name="minimumDistance">The minimum distance.</param>
        /// <param name="maximumDistance">The maximum distance.</param>
        /// <returns>If success, the generated position; otherwise, returns <see cref="Rage.Vector3.Zero" />.<br /></returns>
